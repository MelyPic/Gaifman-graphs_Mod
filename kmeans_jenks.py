...
def getGVF( dataList, numClass ):
  ...
  print('breaks: ', breaks)
  #donde se rompe el cluster
  #lo siguiente asignaria el valor a un cluster
  labels =[]
  for i in array:
	  print(i,' in: ', classify(i,breaks))
	  labels.append(classify(i,breaks))
  return labels		
  dataList.sort()
  ...
  for i in range(0,numClass):
    ...
    print ('classMean: ', classMean) #valor medio del cluster
...
#array =[[25,0], [1,1], [20,2],[1,0], [10,1], [10,2]]
#array =[25,0, 1,1 ,20,2, 1,0, 10,1, 10,2]
#array =[25, 1 ,20, 1, 10, 10]
#print('getGVF: ',getGVF(array,4))
